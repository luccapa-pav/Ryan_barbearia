...
export function ThemeToggle() {
  ...
  function toggle() {
    const next = !isDark
    // Disable transitions briefly to prevent color flash
  ...
  return (
    <button
      ...
      className="relative flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/80 transition-all duration-200 active:scale-90"
    >
