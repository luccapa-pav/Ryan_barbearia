...
export function GraficoStatus({ leads }: GraficoStatusProps) {
  ...
  const panelClass =
    'group bg-card rounded-xl border border-border hover:border-primary shadow-card hover:shadow-elevated transition-all duration-200 hover:scale-[1.015] hover:-translate-y-0.5 p-5 space-y-4 overflow-hidden relative cursor-default'
